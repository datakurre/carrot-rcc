...

{
  ...
  system.build.vagrantHyperV = pkgs.runCommand
    ...
    ''
      ...
      cat << VMFILE > "Virtual Machines/vm.XML"
...
<configuration>
    ...
    <Connection>
      ...
      <Feature_C885BFD1-ABB7-418F-8163-9F379C9F7166>
        ...
        <Setting_A0B25B27-C698-4120-AD49-4CBE3DC028C5>
          <Data type="bytes">AAIAAGQAAAAAAAAAAQAAAAAAAAA=</Data>
      ...
      <TestReplicaPoolId type="string"/>
      <TestReplicaSwitchName type="string"/>
    </Connection>
  ...
  <_83f8638b-8dca-4152-9eda-2ca8b33039b4_>
    ...
    <controller0>
      <drive0>
        ...
        <pathname type="string">C:\dev\vagrant\factory\.vagrant\machines\default\hyperv\disk.vhd</pathname>
  ...
  <properties>
    <creation_time type="bytes">AdYfPQTrPYA=
</creation_time>
    ...
    <name type="string">centos-7-1-1.x86_64</name>
    <notes type="string"/>
